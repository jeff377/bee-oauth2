...
namespace Bee.OAuth2
{
    ...
    public class TFacebookOAuthProvider : IOAuthProvider
    {
        ...
        /// <returns>Facebook OAuth2 授權 URL</returns>
        ...
        /// <summary>
        /// 透過授權碼 (Authorization Code) 交換 Access Token，支援 PKCE。
        /// </summary>
        /// <param name="authorizationCode">Facebook 回傳的授權碼</param>
        ...
        {
            var request = new HttpRequestMessage(HttpMethod.Get, $"{_Options.UserInfoEndpoint}?fields=id,name,email,picture&access_token={accessToken}");
